...
?>
        ...
        $Cursos->exeSelect("cursos",
            multPesquisa(2, $_SESSION['ano'], $post['text'], $post['categoria'], $post['estado']),
            multPesquisa(1, $_SESSION['ano'], $post['text'], $post['categoria'], $post['estado']));


require "../../Parts/Manutencao_Cursos_Content_While_Basico.php";



function multPesquisa($Contexto, $Ano, $Text, $Categoria = null, $Estado = null)
{

    $Termos = "WHERE  
    data_inicio <= :data_inicio AND
    data_final >= :data_final AND 
    nome LIKE :like
    ";
    $Array = array("data_inicio" => $Ano . '-12-12', 'data_final'=> $Ano.'-01-01', 'like' => $Text);
    ...
    switch ($Estado) {
        case 1:
            ...
            $Array = array_merge($Array, array('data_atual' => date("Y-m-d"), 'cancelado' => 1, 'zero' => "0000-00-00"));
            break;
        case 2:
        ...
        case 4:
            ...
            $Array = array_merge($Array, array('cancelado' => 1, 'zero' => "0000-00-00"));
            break;
    }
