...
$Ptext = $get['text'];
$PnumDia = $get['numDia'];
$PdiaSemana = $get['diaSemana'];
$Pestado = $get['estado'];


$PagerAno = new Paginacao;
$PagerAno->setPagincao($Gpage, 1, 'before', 'after');

// Selecionad e acordo com o mes
$mesSelect = new Select;
$mesSelect->exeSelect("anos", "LIMIT :limit OFFSET :offset", array('limit' => $PagerAno->getLimit(), 'offset' => $PagerAno->getOffset()));
