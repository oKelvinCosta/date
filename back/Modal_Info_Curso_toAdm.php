    ...
    <div>
        ...
        <div class="info_options">
            ...
            <div>
                ...
                "
                >PLANO</a>
                <a href="#" id="alterar_toadm" data-id_curso-type="<?= $C['id_curso']?>">ALTERAR</a>
                <a href="#" id="refutar_toadm" data-id_curso-type="<?= $C['id_curso']?>">REPROVAR</a>
                <a href="#" id="aprovar_toadm" data-id_curso-type="<?= $C['id_curso']?>">APROVAR</a>
            </div>
        </div>
