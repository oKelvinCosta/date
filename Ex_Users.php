                ...
                <ul class="pesq">
                    ...
                    <li>
                        <form action="#" method="post" id="PesquisaU">
                            ...
                            <input type="text" name="text" id="textU" placeholder="Pesquisar Ex Usuário">
...
<script>
    ...
    //**
    var user_readicionar = className('user_readicionar');
...
// QUANDOF AZ UPDATE A PESQUISA SE INVALIDA
    ...
    // Readicionar User
    function Readicionar_User(event) {
        textU = id('textU');
        user_readicionar = className('user_readicionar');

        for (var i = 0; user_readicionar[i]; i++) {
            user_readicionar[i].onclick = function (event) {
                event.stopPropagation();
                loadDoc_Readicionar_User("back/Ex_Users/Readcionar_ExUser.php?idUser=" + this.getAttribute('data-user_id-type')+"&text="+textU.value);
            };
        }

    }

    function loadDoc_Readicionar_User(Url) {
    ...
    function PesquisaU() {
        ...
        textU.onkeyup = function () {
            loadDoc_PesquisaU_User("back/Ex_Users/Pesquisa_ExUser.php");
        };
    }
    ...
    function open_Modal_EditarU() {
        for (var i = 0; user_editar[i]; i++) {
            user_editar[i].onclick = function (e) {
                e.stopPropagation();
